...
/*
 * Scenario : Handing the Questions with Yes - No - TryItFree options and completing the
 * Registration , Onboarding and Signout Process
 *
 */
...
' Handing the questions with Yes No TryItFree options'
